...
const routes: Routes = [
  { path: 'correnciaaluno/cadastrar', component: CadastrarOcorrenciaAlunoComponent,canActivate: [AuthGuard],resolve: {perfilAcesso:AcessoModuloResolver}, data:{modulo:Modulos.OCORRENCIA_ALUNO} },
